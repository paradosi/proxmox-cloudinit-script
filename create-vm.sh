...
# Sets CLOUD_IMG_URL, CLOUD_IMG_FILE, and DEFAULT_USER for a given Ubuntu
# release codename. Adding a new Ubuntu release only requires adding one menu
# line and one call to this function.
ubuntu_cloud_image() {
    local codename="$1"
